        ...
        <View style={styles.modalContainer}>
          ...
          >
            ...
            <Text style={styles.metaInfo}>
              Developers: Kartik Yanganti & Vinay Jadal | Country: India | App: SaloonQ | Effective: November 2025
            </Text>

            <Text style={styles.sectionTitle}>1. Ownership</Text>
            <Text style={styles.paragraph}>
              The <Text style={styles.italic}>SaloonQ</Text> application ("App") is
              developed and owned by <Text style={styles.bold}>Kartik Yanganti & Vinay Jadal</Text>.
            ...
            <Text style={styles.contactEmail}>📧 vinay.jadal23@gmail.com</Text>
            <Text style={styles.copyright}>
              © 2025 Kartik Yanganti & Vinay Jadal. All rights reserved.
            </Text>
          </ScrollView>
        </View>
      </View>
