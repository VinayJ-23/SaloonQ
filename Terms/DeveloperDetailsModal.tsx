...
const DeveloperDetailsModal: React.FC<DeveloperDetailsModalProps> = ({
  ...
  const fetchDeveloperLinks = async () => {
    try {
      setLoading(true);
      const adminDoc = await getData('admin', 'links');
  ...
  const handleEmailPress1 = () => {
   ...
   const handleEmailPress2 = () => {
    Linking.openURL('mailto:vinay.jadal23@gmail.com');
  };
              ...
              <>
                ...
                <View style={styles.card}>
                  ...
                  <Text style={styles.aboutText}>
                    This is a project built with passion and dedication to
                    showcase modern mobile development practices using React Native Expo
                    and Firebase.
                  </Text>
                </View>
                ...
                <View style={styles.card}>
                  <View style={styles.developerInfo}>
                    <Text style={styles.developerName}>Kartik Yanganti & Vinay Jadal</Text>
                    <Text style={styles.developerRole}>Web & Mobile Developers</Text>
                  </View>
...
const styles = StyleSheet.create({
  modalOverlay: {
    ...
    alignItems: 'center',
    padding: 20,
    marginHorizontal:isMobileSize?0:"20%"
  },
  modalContent: {
