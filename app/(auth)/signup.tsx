...
import { getData, setData, signUp } from "@/firebase";
...
export default function SignUp() {
  ...
  const handleEmailSignup = async () => {
    try {
      ...
      const phoneDoc = await getData("phoneToMail", phone);
      ...
      await setData("users", uid, userObj);

      // 📱 Save phone → email mapping (modular API)
      const setPhone={
        email,
      }
      await setData("phoneToMail", phone, setPhone);
